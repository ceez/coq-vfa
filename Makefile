...
# coq_makefile OTHERFLAGS = -Q . VFA COQLIBS =  -install none Maps.v Preface.v Perm.v Sort.v Multiset.v Selection.v SearchTree.v ADT.v Extract.v Redblack.v Trie.v Priqueue.v Binom.v Decide.v Color.v -o Makefile 
#
...
.merlin:
	...
	@echo "B /Users/bcpierce/work/sf/new/vfa/full" >> .merlin
	@echo "S /Users/bcpierce/work/sf/new/vfa/full" >> .merlin
...
$(addsuffix .d,$(VFILES)): %.v.d: %.v
	$(SHOW)'COQDEP $<'
	$(HIDE)$(COQDEP) -Q . VFA $(COQLIBS) "$<" > "$@" || ( RV=$$?; rm -f "$@"; exit $${RV} )
