...
Definition abstract {A: Type} (t: trie_table A) (n: id) : A :=
  match n with Id n' => lookup (nat2pos n') t end.
...
Theorem lookup_relate: forall {A} i (t: trie_table A) m,
    is_trie t -> Abs t m -> lookup i t = m (Id (pos2nat i)).
(* FILL IN HERE *) Admitted.
(** [] *)
...
Theorem insert_relate: forall {A} k (v: A) t cts,
    is_trie t ->
    Abs t cts ->
    Abs (insert k v t) (t_update cts (Id (pos2nat k)) v).
(* FILL IN HERE *) Admitted.
(** [] *)
